package com.example.newcompose.core.designsystem.icon
...
/**
 * Project icons. Material icons are [ImageVector]s, custom icons are drawable resource IDs.
 */
object NewComposeIcons {
   ...
   //example of ImageVector //val Chat = ImageVector.vectorResource(R.drawable.ic_chat)
